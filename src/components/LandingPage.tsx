      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600/20 border border-blue-500/30 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-blue-400">Simple. Secure. Trusted.</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="px-8 py-4 bg-gray-800 text-white font-semibold rounded-lg border border-gray-700 hover:bg-gray-700 hover:shadow-md transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg hover:border-gray-600 transition-colors">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">For Vibe Coders</h3>
            <p className="text-gray-400">
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg hover:border-gray-600 transition-colors">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Copy-Paste AI Prompts</h3>
            <p className="text-gray-400">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-8">Choose Your Checklist</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700 hover:border-blue-500/50 transition-all">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white">Go-Live Checklist</h3>
              </div>
            ...
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700 hover:border-green-500/50 transition-all">
              <div className="flex items-center gap-3 mb-4">
                <Sparkles className="w-8 h-8 text-green-500" />
                <h3 className="text-2xl font-bold text-white">Local SEO Checklist</h3>
              </div>
              <p className="text-gray-400 mb-6">
        ...
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 sm:p-12 mb-16 text-white border border-gray-700">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-8">The Four Pillars</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg text-center hover:border-gray-600 transition-colors">
              <div className="text-4xl mb-3">🔍</div>
              <h3 className="font-semibold text-white mb-2">SEO & Discoverability</h3>
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg text-center hover:border-gray-600 transition-colors">
              <div className="text-4xl mb-3">♿</div>
              <h3 className="font-semibold text-white mb-2">Accessibility & UX</h3>
              <p className="text-sm text-gray-400">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg text-center hover:border-gray-600 transition-colors">
              <div className="text-4xl mb-3">🛠️</div>
              <h3 className="font-semibold text-white mb-2">Technical Performance</h3>
              <p className="text-sm text-gray-400">
        ...
        <div className="bg-gradient-to-br from-blue-600/20 to-blue-500/10 rounded-xl p-8 sm:p-12 text-center border border-blue-500/30">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Ship Confidently?</h2>
